...
Swiss is a bold Jekyll theme inspired by Swiss design and the works of Massimo Vignelli. It was originally written by Broccolini and modified by me for my blog. You should go to her website and read it about!
...
```yaml
remote_theme: EverybodyKurts/swiss
```
